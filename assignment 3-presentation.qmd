...
-   Double-edged role:
    ...
    -   [Support connection and self-expression]{style="font-size: 0.9em;"}
    -   [Displace essential habits like sleep and study]{style="font-size: 0.9em;"}
...
-   Increased usage leads to more interpersonal conflicts.
-   Negative relationship found between daily usage hours and mental health.
-   WhatsApp, TikTok, and Snapchat users show the highest usage and addiction scores.
